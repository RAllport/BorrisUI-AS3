...
package Borris.applications 
{
	...
	public class BMobileApplication extends Sprite
	{
		// constants
		...
		private var _autoOrient:Boolean =  true;
		
		
		public function BMobileApplication() 
		{
			// constructor code
			...
			// event handling
			//stage.addEventListener(StageOrientationEvent.ORIENTATION_CHANGE, orientaionChnageHandler);
