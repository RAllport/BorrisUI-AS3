...
package Borris.controls.charts 
{
	...
	public class BGraph extends Sprite
	{
		// constants
		
		
		// assets
		protected var container:Sprite;									// container to hold the graphs, and grid
		...
		protected var _labelsPosition:String = "edge";			// The position of the number labels. Either "edge" or "origin"
