 ...
 *
 * Decription: An object to manage the tabs of a BPanelWindow or BPanelAttached Object
 * 
 * 
*/
...
package Borris.panels
{
	...
	public class BATabManager
	{
		...
		private var _panel:BPanelAttached;				// [read-only] a refernce to the panel containing this tab manager
		...
		public function BATabManager(panel:BPanelAttached) 
		{
			// constructor code
			_panel = panel;
		...
		// 
		public function removeTabAt(tab:BPanelTab):BPanelTab
		{
		...
		// function getTabAt
		// 
		public function getTabAt(index:int):BPanelTab
		{
			return tabs[index];
		} // end function getTabAt
		
		
		// function getTabByLabel
		// 
		public function getTabByLabel(label:String):BPanelTab
		{
			var tab:BPanelTab;
		...
		} // end function getTabByLabel
		
		
		// function getTabIndex
		// 
		public function getTabIndex(tab:BPanelTab):int
		{
		...
		// function switchTab
		// 
		public function switchTab(tab:BPanelTab):void
		{
			...
			trace("BATabManager.switchTab | selected tab: " + _selectedTab.label)
		...
		// panel
		public function get panel():BPanelAttached
		{
			return _panel;
		}
